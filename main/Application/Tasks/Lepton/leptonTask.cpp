...
esp_err_t Lepton_Task_Start(App_Context_t *p_AppContext)
{
    ...
    Error = xTaskCreatePinnedToCore(Task_Lepton, "Task_Lepton", CONFIG_LEPTON_TASK_STACKSIZE, p_AppContext, CONFIG_LEPTON_TASK_PRIO, &_Lepton_Task_State.TaskHandle, CONFIG_LEPTON_TASK_CORE);
    if (Error != pdPASS) {
