 ...
 */
static esp_err_t PortExpander_SetPinLevel(i2c_master_dev_handle_t *p_Dev_Handle, PortDefinition_t Port, uint8_t Mask,
                                          uint8_t Level)
{
 ...
 *                      ESP_ERR_INVALID_STATE when the I2C interface isn´t initialized
 */
static esp_err_t PortExpander_SetInterruptMask(i2c_master_dev_handle_t *p_Dev_Handle, PortDefinition_t Port,
                                               uint8_t Mask, uint8_t EnableMask)
{
